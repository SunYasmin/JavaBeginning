package p03_JavaPractise;public class C07_SwitchCase {
  ...
  public static void main(String[] args) {
        ...
        int sayi = scan.nextInt();  // burda sayiyi okuyoruz

        int birlerBasamagi = sayi % 10, onlarBas = (sayi / 10) % 10, yuzlerBas = sayi / 100;  // multiple declaration
        ...
        if (sayi > 99 && sayi < 1000) {
            switch (yuzlerBas) {
                ...
                case 1:
                    ...
                    break;  //  \t bundan sonra gelen sayi bir tab kadar bosluk olsun diye
                case 2:
