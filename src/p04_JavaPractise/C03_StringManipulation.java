...
public class C03_StringManipulation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. yontem : "+ str1 + " " +str2);  // bu aradaki bosluk birlestiriyor normal yaptigimiz
        ...
        System.out.println("manipulation sonrasi hali : "+ str1_0indextenSonrasi +""+ str2_0indextenSonrasi);
        // atama yapmadan 20 ve 21 in sagini yazarak oluuurrr
        //bir daha yaaaappppppppp
